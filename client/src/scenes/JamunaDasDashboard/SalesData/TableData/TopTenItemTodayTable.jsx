...
const TopTenItemTodayTable = ({
    ...
    const downloadExcel = async () => {
        ...
        /* ================= TITLE ================= */
        worksheet.insertRow(1, ["Top Ten Item Today Sales Report"]);
        ...
        saveAs(
            ...
            "Top Ten Item Today Sales Report.xlsx"
        );
    };
            ...
            <div className="bg-white w-[1350px] h-[630px] p-4 rounded-xl relative">
                ...
                <div className="flex justify-between items-center">
                    <h2 className="font-bold uppercase">
                        Top Ten item Today Sales - <span className="text-blue-600 ">{localCompany || ""}</span>
                    </h2>
...
export default TopTenItemTodayTable;
