...
import { useGetTopTenCustomerMonthTableQuery } from
...
const TopTenCustomerMonthWiseTable = ({
    year, customer, company, closeTable, finYrData, customerOptions, month, setSelectedYear, selectedYear, setSelectMonths, selectMonths, selectedfilterType, setSelectedFilterType
}) => {
    ...
    useEffect(() => {
        setSelectedCustomer(customer || "ALL");
        setCurrentPage(1);
    }, [customer]);
    useEffect(() => {
    ...
    const downloadExcel = async () => {
        ...
        /* ================= TITLE ================= */
        worksheet.insertRow(1, ["Top Ten Customer Month Wise Sales Report"]);
        ...
        saveAs(
            ...
            "Top Ten Customer Month Wise Sales Report.xlsx"
        );
    };
            ...
            <div className="bg-white w-[1370px] h-[630px] p-4 rounded-xl relative">
                ...
                <div className="flex justify-between items-center">
                    <h2 className="font-bold uppercase">
                        Top Ten Customer Month Wise Sales - <span className="text-blue-600 ">{localCompany || ""}</span>
                    </h2>
...
export default TopTenCustomerMonthWiseTable;
