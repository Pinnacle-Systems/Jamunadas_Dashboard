...
import { useGetTopTenItemMonthTableQuery } from "../../../../redux/service/jamunasDashboardService";
...
const TopMonthTable = ({
  ...
  console.log(valueType, "receivedparams");
  ...
  const totalQty = useMemo(
    () => filteredData.reduce((sum, r) => sum + Number(r.invoiceQty || 0), 0),
    [filteredData],
  );
  // ✅ EXCEL EXPORT
