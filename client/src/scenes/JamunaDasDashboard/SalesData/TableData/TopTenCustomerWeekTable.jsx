...
import { useGetTopTenCustomerWeekTableQuery } from
...
const TopTenCustomerWeekWiseTable = ({
    ...
    const downloadExcel = async () => {
        ...
        /* ================= TITLE ================= */
        worksheet.insertRow(1, ["Top Ten Customer Week Wise Sales Report"]);
        ...
        saveAs(
            ...
            "Top Ten Customer Week Wise Sales Report.xlsx"
        );
    };
            ...
            <div className="bg-white w-[1370px] h-[630px] p-4 rounded-xl relative">
                ...
                <div className="flex justify-between items-center">
                    <h2 className="font-bold uppercase">
                        Top Ten Customer Week Wise Sales - <span className="text-blue-600 ">{localCompany || ""}</span>
                    </h2>
...
export default TopTenCustomerWeekWiseTable;
