...
import {
  ...
  getYearlySales,
  getTopTenCustomer,
  getTopTenCustomerMonth,
  getTopTenCustomerWeek,
  getTopTenCustomerToday,
  getTopTenItemYear,
  getTopTenItemMonth,
  getTopTenItemWeek,
  getTopTenItemToday,
...
router.get("/getLowestHighestMovement", getLowestandHighest);
